...
/*
 * Código Basado en https://github.com/jumejume1/AX-12A-servo-library/blob/master/src/AX12A.h
 * Autor: Andrés Morales 
 *
 */

#ifndef __MAKI_CONTROLLER_HPP__
#define __MAKI_CONTROLLER_HPP__
...
public:
	...
	int setOperatingMode(unsigned char ID, uint8_t mode);
...
extern MakiController maki_controller;
