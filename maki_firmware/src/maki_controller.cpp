...
int MakiController::read_error(void)
{
...
void MakiController::begin(long baud, unsigned char directionPin, HardwareSerial *srl)
{
	varSerial = srl;
...
void MakiController::end()
{
	endCom();
}

int MakiController::reset(unsigned char ID)
{
...
int MakiController::ping(unsigned char ID)
{
	const unsigned int length = 6;
	unsigned char packet[length];
...
int MakiController::setID(unsigned char ID, unsigned char newID)
{    
...
int MakiController::setBD(unsigned char ID, long baud)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::move(unsigned char ID, int Position)
{
...
int MakiController::moveSpeed(unsigned char ID, int Position, int Speed)
{
...
int MakiController::setEndless(unsigned char ID, bool Status)
{
	if ( Status )
	{
		const unsigned int length = 9;
...
int MakiController::turn(unsigned char ID, bool SIDE, int Speed)
{		
		if (SIDE == LEFT)
		{
...
int MakiController::moveRW(unsigned char ID, int Position)
{
    char Position_H,Position_L;
    Position_H = Position >> 8;           // 16 bits - 2 x 8 bits variables
    Position_L = Position;
...
int MakiController::moveSpeedRW(unsigned char ID, int Position, int Speed)
{
    char Position_H,Position_L,Speed_H,Speed_L;
    Position_H = Position >> 8;    
    Position_L = Position;                // 16 bits - 2 x 8 bits variables
...
int MakiController::torqueStatus( unsigned char ID, bool Status)
{
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::ledStatus(unsigned char ID, bool Status)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::readTemperature(unsigned char ID)
{	
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::readPosition(unsigned char ID)
{	
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::readVoltage(unsigned char ID)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setTempLimit(unsigned char ID, unsigned char Temperature)
{
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setVoltageLimit(unsigned char ID, unsigned char DVoltage, unsigned char UVoltage)
{
	const unsigned int length = 9;
	unsigned char packet[length];
...
int MakiController::setAngleLimit(unsigned char ID, int CWLimit, int CCWLimit)
{
...
int MakiController::setMaxTorque(unsigned char ID, int MaxTorque)
{
...
int MakiController::setSRL(unsigned char ID, unsigned char SRL)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setRDT(unsigned char ID, unsigned char RDT)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setLEDAlarm(unsigned char ID, unsigned char LEDAlarm)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setShutdownAlarm(unsigned char ID, unsigned char SALARM)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setCMargin(unsigned char ID, unsigned char CWCMargin, unsigned char CCWCMargin)
{
...
int MakiController::setCSlope(unsigned char ID, unsigned char CWCSlope, unsigned char CCWCSlope)
{
	const unsigned int length = 10;
	unsigned char packet[length];
...
int MakiController::setPunch(unsigned char ID, int Punch)
{
...
int MakiController::moving(unsigned char ID)
{	
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::lockRegister(unsigned char ID)
{    
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::RWStatus(unsigned char ID)
{	
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::readSpeed(unsigned char ID)
{	
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::readLoad(unsigned char ID)
{	
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::sendAXPacket(unsigned char * packet, unsigned int length)
{
...
void MakiController::sendAXPacketNoError(unsigned char * packet, unsigned int length)
{
	switchCom(Direction_Pin, TX_MODE); 	// Switch to Transmission  Mode
...
int MakiController::readRegister(unsigned char ID, unsigned char reg, unsigned char reg_len)
{
	const unsigned int length = 8;
	unsigned char packet[length];
...
int MakiController::setOperatingMode(unsigned char ID, uint8_t mode)
{
    const unsigned int length = 8;
    unsigned char packet[length];

    // Dirección del Operating Mode (PROTOCOL 2.0)
    const uint8_t ADDR_OPERATING_MODE = 11;  

    Checksum = (~(ID + 4 + AX_WRITE_DATA + ADDR_OPERATING_MODE + mode)) & 0xFF;

    packet[0] = AX_START;
    packet[1] = AX_START;
    packet[2] = ID;
    packet[3] = 4;                  // length (instruction + params + checksum)
    packet[4] = AX_WRITE_DATA;      // 0x03
    packet[5] = ADDR_OPERATING_MODE; 
    packet[6] = mode;               // el modo a escribir
    packet[7] = Checksum;
...
MakiController maki_controller;